...
<html lang="en">
    ...
    <body>
        <header class="header">
            <h1>E-COURRIER</h1>
            <p>Administateur</p> <!-- QUAND C'EST L'ADMINISTRATEUR QUI SE CONNECTE-->
            <div class="user-case-header"  style="display: none"> <!-- QUAND C'EST UN UTILISATEUR QUI SE CONNECTE-->
                <p>Utilisateur</p>
