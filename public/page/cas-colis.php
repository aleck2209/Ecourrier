...
<body>
    ...
    <div class="content">
        ...
        <main class="main">
            ...
            <section class="page-content-package-case">
                <h2>Colis</h2>
                <!-- DEBUT DU FORMULAIRE -->
                <form action="" method="post" class="form-package-case">
                    <!-- DEBUT INFORMATION COURRIER -->
                    <h3>Information courrier</h3>
                    <div class="fields-package-case">
                        <div class="package-description">
                            <label for="">Description du colis</label>
                            <textarea rows="5" cols="33" name="" id="" resize="vertical"></textarea>
                        </div>
                        <div class="field">
